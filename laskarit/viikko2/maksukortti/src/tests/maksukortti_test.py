...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortin_negatiivinen_lataaminen_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-2000)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_edullinen_lounas_voidaan_ostaa_vaikka_tililla_tasaraha(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_maukas_lounas_voidaan_ostaa_vaikka_tililla_tasaraha(self):
